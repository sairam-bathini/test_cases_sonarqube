...
public class Admin_BulkWithdraw_Incomplete_Side extends Admin_BaseClass {
    ...
    public void tableSendCTADisplays() throws Throwable {
        adminLogin.login1();
        Admin_BulkWithdraw_Incomplete_Side_Page data = PageFactory.initElements(driver, Admin_BulkWithdraw_Incomplete_Side_Page.class);
