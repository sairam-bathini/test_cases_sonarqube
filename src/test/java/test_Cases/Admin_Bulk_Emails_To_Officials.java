...
import page_Object.Admin_Bulk_Emails_To_Officials_Page;
import test_Base.Admin_BaseClass;
import test_Base.Admin_Login;
import test_Base.Admin_Logout;

public class Admin_Bulk_Emails_To_Officials extends Admin_BaseClass {
    ...
    public void tableSendCTADisplays() throws Throwable {
        adminLogin.login1();
        Admin_Bulk_Emails_To_Officials_Page data = PageFactory.initElements(driver, Admin_Bulk_Emails_To_Officials_Page.class);
