...
public class Admin_BulkWithdraw_Incomplete_Side_Page extends Admin_BaseClass {
    public Admin_BulkWithdraw_Incomplete_Side_Page(WebDriver driver) {
        this.driver = driver;
    }

    @FindBy(xpath = "//div[text()='Email Management']")
    WebElement emailMgmt;
    @FindBy(xpath = "//*[text()='Bulk Withdraw Incomplete Side Emails']")
    WebElement bulkWithdrawIncompleteSideEmails;
    ...
    public void tableSendCTADisplays() throws Throwable {
        ...
        bulkWithdrawIncompleteSideEmails.click();
        Thread.sleep(1000);
